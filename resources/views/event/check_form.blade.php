...
<div class="col">
    ...
    <input type="text" name=''  class="form-control" placeholder="お名前" aria-label="">
  </div>
  <div class="col">
    <label for="exampleInputEmail1" class="form-label">フリガナ</label>
    <input type="text" name='' class="form-control" placeholder="フリガナ" aria-label="">
  </div>
...
<div class="row">
   ...
   <div class="col">
    ...
    <input type="number" name='' class="form-control" placeholder="電話番号" aria-label="">
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">メールアドレス</label>
    <input type="email" name='' class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="メールアドレス">
  ...
  <div class="mb-3 col-4">
    ...
    <input type="number" name='' class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="お子様の年齢">

  </div>
  <div class="col">
    <label for="exampleInputEmail1" class="form-label">コメント欄（お子様が２名以上参加される場合、追加の人数と年齢をご記入ください）</label>
    <div class="form-floating">
  <textarea class="form-control" name='' placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" placeholder="お子様の年齢"></textarea>
