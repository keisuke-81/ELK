...
') }}"> --}}
            ...
            <form method="POST" action="{{ route('store') }}" class="row g-3" enctype="multipart/form-data">
                ...
                <input type="file" name="image">
                @error('image')
                <div class="alert alert-danger">画像を入力してください</div>
                @enderror
            ...
            <div class="col-12"><h2>イベント情報入力</h2></div>
             ...
             @error('title')
              <div class="alert alert-danger">イベントの名前を入力してください</div>
            @enderror
             </div>
                <div class="col-md-6">
                ...
                @error('event_day')
                <div class="alert alert-danger">日にちを入力してください</div>
                 @enderror
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            <label for="inputAddress" class="form-label">school_id</label>
                            <input type="number" name="school_id" class="form-control" id="inputAddress" placeholder="">
                            @error('school_id')
                              <div class="alert alert-danger">スクールネームナンバーを入力してください</div>
                            @enderror
                        </div>
                        {{-- <div class="col-12">
                        ...
                        <div class="col-6">
                            <label for="inputAddress2" class="form-label">priceFree=0 , notFree=1</label>
                        ...
                        <div class="col-6">
                            ...
                            @error('event_url')
                              <div class="alert alert-danger">event_urlを入力してください</div>
                            @enderror
                        </div>
                        <div class="col-2">
                        ...
                        <div class="col-12">
                            ...
                            @error('content')
                              <div class="alert alert-danger">内容を入力してください</div>
                            @enderror
                        </div>
                        <div class="col-12">
